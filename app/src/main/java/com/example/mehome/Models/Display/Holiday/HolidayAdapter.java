...
public class HolidayAdapter extends RecyclerView.Adapter<HolidayAdapter.ImageViewHolder> {
    private Context mContext;
    private List<HolidayData> mUploads;
    private OnItemClickListener mListener;

    public HolidayAdapter(Context context, List<HolidayData> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.holidayimageitem, parent, false);
